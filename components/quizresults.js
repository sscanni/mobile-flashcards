...
class QuizResults extends Component {
    ...
    render() {
        ...
        const correctCount = this.props.navigation.state.params.correctCount
        ...
        return (
            <View style={{alignItems: 'center'}}>
                ...
                <Text  style={{ textAlign: 'center', marginTop: 60, fontSize: 24 }}>{correctCount} out of 4 correct</Text>
                ...
                {/* {this.state.question === true ? (
                    ...
                    {this.state.card+1 === entries[key].cards.length ? (
                        <View style={{alignItems: 'center'}}>
                            ...
                            <Text style={{ fontSize: 16 }}>Exit Quiz</Text>
                            </TouchableOpacity>
                        </View>
                    ) : (
        ...
        // const cardList = entries[key].cards.map((card, key) => {
        //     return (
        //         <View key={key}>
        //             <Text  style={{ textAlign: 'center', marginTop: 60, fontSize: 24 }}>{card.question}</Text>
